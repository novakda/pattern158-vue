...
export const Default: Story = {
  args: {
    finding: {
      ...
      outcome:
        'System served ~20 energy utilities (each drawing a curated subset from a ~2,000 course central library). Remained in production 10+ years.',
...
export const WithoutLink: Story = {
  args: {
    finding: {
      ...
      solution:
        'Decompiled Java/JSP packages to understand system behavior. Built JavaScript workarounds where server-side refactoring was not practical. Maintained critical system beyond expected EOL.',
      outcome:
...
export const AIFinding: Story = {
  args: {
    finding: {
      ...
      analysis:
        'Needed AI instructor agent in Copilot Studio. Prompt engineering alone could not establish reliable guardrails for progress tracking and navigation.',
      solution:
        'Built data pipeline converting eLearning course materials into structured JSON. Used AI code interpreter for content transformation, structured data for deterministic control.',
      outcome:
