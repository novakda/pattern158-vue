  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        type: 'text',
        heading: 'Outcome',
        body: "Findings were shared with management and the governance architect via a documented deliverable \u2014 an internal repo containing findings, prompts, and annotated analysis. This case demonstrates how forensic engineering methodology, augmented by AI-assisted analysis, can surface foundational gaps early \u2014 before they become production failures. The earlier these methods are applied, the more costly the problems they prevent.\n\nThe analysis provided the governance team with the first complete picture of the system's technical debt.",
      },
      {
        type: 'table',
        heading: 'Technologies',
      ...
      },
      {
        ...
        columns: ['Field', 'Value'],
        rows: [
          ['Industry', 'Enterprise / Internal Systems'],
          ['Duration', '1 year'],
          ['Personnel Involved', '4 individuals'],
