...
```bash
INIT=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" init progress)
...
- `STATE=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" state-snapshot)`
...
- Use `summary-extract` for efficient parsing:
  ```bash
  node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" summary-extract <path> --fields one_liner
  ```
...
PROGRESS_BAR=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
