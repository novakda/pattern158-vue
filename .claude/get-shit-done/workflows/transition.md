...
```bash
TRANSITION=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" phase complete "${current_phase}")
```
...
```bash
PROGRESS=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" progress bar --raw)
```
...
```bash
node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" config-set workflow._auto_chain_active false
```
