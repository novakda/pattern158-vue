...
<required_reading>
@C:/main/pattern158-vue/.claude/get-shit-done/references/continuation-format.md
</required_reading>
...
```bash
INIT=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" init resume)
