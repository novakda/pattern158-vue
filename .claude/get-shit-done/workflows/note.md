...
- **Global scope**: `/home/xhiris/projects/pattern158-vue/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/xhiris/projects/pattern158-vue/.claude/notes/`)
...
2. Glob `/home/xhiris/projects/pattern158-vue/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/xhiris/projects/pattern158-vue/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/xhiris/projects/pattern158-vue/.claude/notes/` — works in any directory
