...
- Usage: Reference from command with `@/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/xhiris/projects/pattern158-vue/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/xhiris/projects/pattern158-vue/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
