...
Use template from `C:/main/pattern158-vue/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/main/pattern158-vue/.claude/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
