...
Reference full template: `/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/templates/state.md`.
