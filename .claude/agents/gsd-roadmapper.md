...
Reference full template: `C:/main/pattern158-vue/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/main/pattern158-vue/.claude/get-shit-done/templates/state.md`.
