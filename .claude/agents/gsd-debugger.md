...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/xhiris/projects/pattern158-vue/.claude
                  → checks /home/xhiris/projects/pattern158-vue/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/xhiris/projects/pattern158-vue/.claude/get-shit-done
                  → writes to /home/xhiris/projects/pattern158-vue/.claude/get-shit-done/hooks/
...
```bash
INIT=$(node "/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/home/xhiris/projects/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
