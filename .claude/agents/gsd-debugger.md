...
```bash
INIT=$(node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "C:/main/pattern158-vue/.claude/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
