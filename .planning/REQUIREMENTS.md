...
- [x] **SCAF-02
**: New `tsconfig.editorial.json` mirroring `tsconfig.scripts.json` — composite=true, rootDir=., `include: ["scripts/editorial/**/*.ts"]`, `paths: {}`, outDir `.tsbuildinfo-editorial`, `lib: ["ES2022"]` (DOM added only if Phase C needs it)
- [x] **SCAF-03
